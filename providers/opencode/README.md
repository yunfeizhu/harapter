...
<p align="center">
  <a href="https://www.npmjs.com/package/@harapter/adapter-opencode"><img src="https://img.shields.io/npm/v/%40harapter%2Fadapter-opencode?style=flat-square&amp;label=npm" alt="npm version"></a>
...
| Variable                   | Value                                                                                             |
| -------------------------- | ------------------------------------------------------------------------------------------------- |
| `HARAPTER_OPENCODE_URL`    | Your running OpenCode HTTP server URL.                                                            |
| `OPENCODE_SERVER_USERNAME` | Server Basic-auth username; the example defaults to opencode.                                     |
| `OPENCODE_SERVER_PASSWORD` | Server Basic-auth password from host secret storage.                                              |
| `HARAPTER_WORKSPACE`       | Absolute path to an existing, empty test directory; for OpenCode it is the server-side directory. |
