...
The committed fixtures are original synthetic Harapter test data. Their manifest
records upstream protocol provenance, not a copy of the protocol package or
captured Provider traffic.
